export function getWindDirection(degrees) {
    ...
    if (degrees >= 56.25 && degrees < 78.75) { return "⬀ NE" }
    ...
    if (degrees >= 146.25 && degrees < 168.75) { return "⬂ SE" }
    if (degrees >= 168.75 && degrees < 191.25) { return "⇩ S" }
    if (degrees >= 191.25 && degrees < 213.75) { return "⬃ SW" }
    if (degrees >= 213.75 && degrees < 236.25) { return "⬃ SW" }
    if (degrees >= 236.25 && degrees < 258.75) { return "⬃ SW" }
